...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "menu.item.foto1.name": "Flankstek & Bea Tradition",
    "menu.item.foto1.desc":
      "Iberico flank steak with béarnaise and your choice of potatoes.\nGratin or wedges",
    "menu.item.foto5.name": "Nordisk Klassiker",
  ...
  es: {
    ...
    "menu.item.foto1.name": "Flankstek & Bea Tradition",
    "menu.item.foto1.desc":
      "Flank steak ibérico con salsa bearnesa y patata a elección.\nGratinada o gajos",
    "menu.item.foto5.name": "Nordisk Klassiker",
  ...
  sv: {
    ...
    "menu.item.foto1.name": "Flankstek & Bea Tradition",
    "menu.item.foto1.desc":
      "Flankstek iberico med bearnaisesås och valfri potatis.\nGratäng/klyftpotatis",
    "menu.item.foto5.name": "Nordisk Klassiker",
    ...
    "menu.item.foto7.name": "La Cueva Gravlaxtoast",
    "menu.item.foto7.desc": "Gravad laxt toast med hovmästarsås\n½ 7 €",
    "menu.item.foto8.name": "Skagen Original",
    "menu.item.foto8.desc": "Toast Skagen vol\n½ 7 €",
    "menu.item.foto3.name": "Wallenbergare à la Stockholm",
    "menu.item.foto3.desc":
